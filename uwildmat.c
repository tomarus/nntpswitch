/*  $Id: uwildmat.c,v 1.3 2003-12-22 09:43:13 tommy Exp $
**
...
*/
PROTO int match_expression(const unsigned char *text, const unsigned char *start, bool allowpoison)
{
...
*/
PROTO int uwildmat_simple(const char *text, const char *pat)
{
    const unsigned char *utext = (const unsigned char *) text;
    const unsigned char *upat = (const unsigned char *) pat;
    size_t length;
